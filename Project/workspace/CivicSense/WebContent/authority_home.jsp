...
<title>Civic Sense | Authority</title>
...
$(document).ready(function(){$().toastmessage('showToast', {
	       text     : 'Handle Complaints easily!<br/><br/>',
	       sticky   : false,
	       stayTime : 6000,
	       position : 'top-right',
	       type     : 'notice'
	...
	<div id="wrapper">
		...
		<div id="navigation">
			<ul>
				...
				<li class="active"><a href="#">Authority</a></li>
		...
		<div id="content">
			<div id="left_column">
				<div class="text">
					<h2>Complaint Scrolls</h2>
						<p><img src="images/scroll.jpg" alt="scrolls"/>The complaints are easy to handle 
						when they are presented in a scrollable interface !</p>
						<p>
						<br/>
						Invalidated complaints are filtered as they are no more taken care by the authorities.
						</p>
						<p>
						<br/>
						The complaint statuses can be modified at ease by just toggling between
						the process levels at which the complaints are.
						</p>
				</div>
				<div class=" text alternative">
					<h2>View the Suggestions</h2>
						<p><img src="images/priority.jpg" alt="priority"/>Keep yourselves updated with 
						the trending citizen opinions.This helps you (authorities) to prioritize your
						complaint handling schedules.
						</p>
				</div>
				<div class="text">
					<h2>Memos</h2>
						<p><img src="images/memo.jpg" alt="memo"/>This is essential as a part
						of any electronic system.The credits that the authorities earn are highly dependent
						upon the memos received.
						</p>
						<a href="index.jsp#linkpoint" class="continue">Authority's login</a>
				</div>
			</div>
