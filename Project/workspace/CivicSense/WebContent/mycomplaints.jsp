...
function shownext()
{
	...
	var number = count;
	xobj = new XMLHttpRequest();
	xobj.open("GET","CitizenView?number="+number+"&type=mytile",false);
	xobj.onreadystatechange = function(){
		if(xobj.readyState == 4 && xobj.status == 200)
	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<ol id="comptile" >
				...
				<div class="text">
					<h2>Suggestions</h2>
						<p><img src="images/suggest.jpg" alt="suggest"/>Let's know about your 
...
<div id="citizenoptions">
	...
	<div>
		...
		<br/>
		<br/>
		<p><a href="CitizenComplaint" style="font-size:14px;color:#65b8f9;">My Complaints</a></p>
		<br/>
		<br/>
